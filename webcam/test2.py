...
# calcola la cartella root del progetto (due livelli sopra questo file)
ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))
MODELS_DIR = os.path.join(ROOT, 'models')
WEIGHTS_PATH = os.path.join(MODELS_DIR, 'model_3.h5')
ARCH_PATH    = os.path.join(MODELS_DIR, 'model.json')
